...
export default class Accueil extends Component {
  ...
  render() {
    ...
    <div className="mt-16 text-center transition-opacity duration-1000 bg-red-600 rounded-md opacity-100  border-slate-100 hover:opacity-0">
            <h1 className="text-4xl font-bold text-amber-50 ">KONE DIAOU</h1>
            <p className="text-lg text-red-300">Bienvenue sur ma page, là pour vous servire  </p>
    </div>
     


    <div className="flex items-center justify-around h-screen mt-8 bg-center bg-cover brightness-100 contrast-125 " style={{backgroundImage: 'url(/ro.jpg)',height:'370px'}}>

     <div className="font-bold">
      <div className="flex items-center justify-center w-16 h-16 transition-transform transform rounded-full bg-amber-50 hover:scale-110 hover:rotate-180 hover:bg-red-600">
      <span className="material-symbols-outlined hover:text-white">description</span>
      </div>
      <h3 className='mt-4 text-xl text-amber-50'>Infos</h3>
    </div>


      <div className="text-center">
        <h1 className="mb-4 text-2xl font-bold text-amber-50">Developper full-stack</h1>
        <p className="text-lg font-bold text-white">Infographe/Graphiste/ <br /> Motion-designer</p>
      </div>
      ...
      <div className="flex items-center justify-center w-16 h-16 transition-transform transform rounded-full bg-amber-50 hover:scale-110 hover:rotate-180 hover:bg-red-600">
        <a href="/anim/CV.pdf"download='CV.pdf'><span className="material-symbols-outlined hover:text-white animate-bounce">arrow_downward</span></a>
          ...
          <h3 className='mt-4 text-xl text-white'>Mon Cv</h3>
      </div>
    </div>
  


    <div className="flex flex-col items-center justify-around mt-16 sm:flex-row" style={{Width:'100%'}}>

        <div className="text-center  max-w-80 sm:mb-0" style={{maxWidth:'50%'}}>
        <h1 className='mb-4 text-6xl font-bold text-red-600 sm:text-6xl'>Qui suis-je</h1>
        <p className='mb-12 text-xl font-bold'>je suis infographe/graphiste depuis 2 ans<br />
        ...
        <a href="/creation" className="p-2 px-24 mt-8 text-white transition duration-150 ease-in-out bg-gray-800 rounded hover:bg-red-600 sm:w-full "> creation</a>
        </div>
      ...
      <h1 className='p-2 mt-8 text-4xl font-bold text-center text-white bg-red-600 '> Infographe </h1>
 ...
 <div class="  sm:grid-cols-2 ">
   ...
   <button className="p-2 mt-8 text-white transition duration-150 ease-in-out bg-gray-800 rounded px-36 hover:bg-red-600">Voir plus</button>
 </div>
          </div>
 ...
 <div class="  sm:grid-cols-2 ">
   <div class="bg-gray-100 p-6 rounded-lg shadow-md w-100">
    ...
    <h1 className='p-2 mt-8 text-4xl font-bold text-center text-white bg-red-600 '> Graphiste </h1>
 ...
 <div class="  sm:grid-cols-2 ">
   <div class="bg-gray-100 p-6 rounded-lg shadow-md w-100">
    ...
    <h1 className='p-2 mt-8 text-4xl font-bold text-center text-white bg-red-600 '> Motion / Montage </h1>
  ...
  <div class="relative overflow-hidden bg-gray-900 rounded-lg shadow-lg h-96">
    <video class="w-full h-full object-cover" controls>
     ...
     <h1 className='p-2 text-4xl font-bold text-center text-white bg-red-600 '> Site web </h1>


    <div className="flex justify-center mt-8 ">
     <div className="px-8 font-bold">
      <div className="flex items-center justify-center w-16 h-16 transition-transform transform bg-gray-800 rounded-full hover:scale-110 hover:rotate-180 hover:bg-red-600">
      <span className="material-symbols-outlined hover:text-white">description</span>
      </div>
      <h3 className='px-6 mt-4 text-xl text-black'>1</h3>
      </div>
      ...
      <h3 className='px-6 mt-4 text-xl text-black'>2</h3>
      </div>
      ...
      <h3 className='px-6 mt-4 text-xl text-black'>3</h3>
      </div>
    ...
    <div className="w-full h-16 mt-8 bg-gradient-to-r from-gray-800 via-gray-500 to-red-600"> <h2 className='pt-2 text-2xl text-center text-white'>Site 2</h2></div>
